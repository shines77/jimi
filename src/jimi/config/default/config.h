...
#ifndef _JIMI_CONFIG_DEFAULT_CONFIG_H_
#define _JIMI_CONFIG_DEFAULT_CONFIG_H_
...
#define JIMI_USE_DEFAULT_CONFIG             1
...
#endif  /* JIMI_USE_DEFAULT_CONFIG */

#endif  /* _JIMI_CONFIG_DEFAULT_CONFIG_H_ */
