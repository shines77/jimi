...
// otherwise it fails to compile by VS2005.
    ...
    #define JIMI_WINBASEAPI     extern "C"
#else
    #define JIMI_WINBASEAPI     WINBASEAPI
#endif

JIMI_WINBASEAPI BOOL WINAPI TryEnterCriticalSection(LPCRITICAL_SECTION);
JIMI_WINBASEAPI BOOL WINAPI InitializeCriticalSectionAndSpinCount(LPCRITICAL_SECTION, DWORD);
...
inline HANDLE WINAPI inlineCreateEventEx(LPSECURITY_ATTRIBUTES lpEventAttributes, LPCTSTR lpName, DWORD dwFlags, DWORD)
{
  ...
  #ifndef JIMI_USE_SRWLOCK
    // TODO: turn it on when bug 1952 will be fixed
    #define JIMI_USE_SRWLOCK    0
  #endif
