...
static void *fast_memcpy(void *dest, const void *src, size_t len)
{
    void *retval;
    size_t i;
    retval = dest;
    ...
    if (len >= MIN_LEN) {
        ...
        delta = ((unsigned long int)dest) & (MMREG_SIZE - 1);
        if (delta) {
...
#endif  /* #if defined(__GUNC__)|| defined(__MINGW__) || defined(__MINGW32__) || defined(__MINGW64__) */
