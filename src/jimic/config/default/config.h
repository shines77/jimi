...
#ifndef _JIMIC_CONFIG_DEFAULT_CONFIG_H_
#define _JIMIC_CONFIG_DEFAULT_CONFIG_H_
...
#define JIMIC_USE_DEFAULT_CONFIG            1
...
#endif  /* JIMIC_USE_DEFAULT_CONFIG */

#endif  /* !_JIMIC_CONFIG_DEFAULT_CONFIG_H_ */
